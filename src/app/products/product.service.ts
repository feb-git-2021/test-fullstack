...
export class ProductService {
  ...
  productUrl:string='http://localhost:50772/api'
...
//Without observables
  ...
  getProduct(id:number):Observable<IProduct>{
    ...
    const url = `${this.productUrl}/ProductsTabs/${id}`
  ...
  const url =`${this.productUrl}/ProductsTabs/${product.productId}`
  ...
  createProduct(product:IProduct):Observable<IProduct>{
    ...
    return this._httpClient.
    post<IProduct>(this.productUrl+'/ProductsTabs',product,
    {headers})
    .pipe(
